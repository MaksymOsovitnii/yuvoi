...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    benefits: Schema.Attribute.Component<"about.about-page-benefits", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    benefitsUnderText: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    prItems: Schema.Attribute.Media<"files", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    prText: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    prTitle: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    underForm: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAboutSubmissionAboutSubmission extends Struct.CollectionTypeSchema {
  collectionName: "about_submissions";
  info: {
    displayName: "About Submission";
    pluralName: "about-submissions";
    singularName: "about-submission";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      "oneToMany",
      "api::about-submission.about-submission"
    > &
      Schema.Attribute.Private;
    ...
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    userLocale: Schema.Attribute.String;
  };
}

export interface ApiContentReportPageContentReportPage extends Struct.SingleTypeSchema {
  collectionName: "content_report_pages";
  info: {
    displayName: "Content Report Page";
    pluralName: "content-report-pages";
    singularName: "content-report-page";
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      "oneToMany",
      "api::content-report-page.content-report-page"
    >;
    publishedAt: Schema.Attribute.DateTime;
    submitButton: Schema.Attribute.Component<"button.button", false> &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiContentReportContentReport extends Struct.CollectionTypeSchema {
  collectionName: "content_reports";
  info: {
    displayName: "Content Report Submission";
  ...
  attributes: {
    ...
    lastName: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::content-report.content-report"> &
      Schema.Attribute.Private;
...
export interface ApiCreatorPageCreatorPage extends Struct.SingleTypeSchema {
  collectionName: "creator_pages";
  info: {
    displayName: "Creator Page";
    pluralName: "creator-pages";
    singularName: "creator-page";
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    creatorButton: Schema.Attribute.Component<"creator.creator-button", false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    creatorInfoBox: Schema.Attribute.Component<"creator.creator-info-box", false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    creatorIntegration: Schema.Attribute.Component<"creator.creator-integration", false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    creatorMotivation: Schema.Attribute.Component<"creator-motivation.creator-motivation", false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    creatorSubmissionFormItem: Schema.Attribute.Component<"creator.creator-submission-form", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::creator-page.creator-page">;
    publishedAt: Schema.Attribute.DateTime;
    underForm: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiCreatorSubmissionCreatorSubmission extends Struct.CollectionTypeSchema {
  collectionName: "creator_submissions";
  info: {
    displayName: "Creator Submission";
    pluralName: "creator-submissions";
    singularName: "creator-submission";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      "oneToMany",
      "api::creator-submission.creator-submission"
    > &
      Schema.Attribute.Private;
    ...
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    userLocale: Schema.Attribute.Enumeration<["en", "de"]>;
  };
}
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    footerAppButton: Schema.Attribute.Component<"footer.footer-app-buttons", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    footerItem: Schema.Attribute.Component<"footer-item.footer-item", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    footerSocialItem: Schema.Attribute.Component<"footer-social-item.footer-social-item", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    becomeCreatorButton: Schema.Attribute.Component<"button.button", false> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    blocks: Schema.Attribute.DynamicZone<
      [
        ...
        "home-statements.home-statements",
      ]
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiInvestorSubmissionInvestorSubmission extends Struct.CollectionTypeSchema {
  collectionName: "investor_submissions";
  info: {
    displayName: "Investor Submission";
    pluralName: "investor-submissions";
    singularName: "investor-submission";
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      "oneToMany",
      "api::investor-submission.investor-submission"
    > &
      Schema.Attribute.Private;
    message: Schema.Attribute.Text & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiInvestorsPageInvestorsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::investors-page.investors-page">;
    partnerCards: Schema.Attribute.Component<"partner-card.partner-card", true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLegalNoticePageLegalNoticePage extends Struct.SingleTypeSchema {
...
export interface ApiNavItemNavItem extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    child: Schema.Attribute.Relation<"oneToMany", "api::nav-item.nav-item">;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::nav-item.nav-item">;
...
declare module "@strapi/strapi" {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      "api::about-submission.about-submission": ApiAboutSubmissionAboutSubmission;
      "api::content-report-page.content-report-page": ApiContentReportPageContentReportPage;
      "api::content-report.content-report": ApiContentReportContentReport;
      "api::creator-page.creator-page": ApiCreatorPageCreatorPage;
      "api::creator-submission.creator-submission": ApiCreatorSubmissionCreatorSubmission;
      "api::footer.footer": ApiFooterFooter;
      "api::home-page.home-page": ApiHomePageHomePage;
      "api::investor-submission.investor-submission": ApiInvestorSubmissionInvestorSubmission;
